...
interface EditHeatConfigModalProps {
  category: Category;
  onSave: (category: Category, config: HeatConfig) => void;
  onClose: () => void;
}

export function EditHeatConfigModal({ category, onSave, onClose }: EditHeatConfigModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3">
          <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Edit Heat Configuration for {category}</h3>
